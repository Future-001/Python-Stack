...
# shutil.copytree("/Users/jingliyang/PycharmProjects/面试题/常用模块/logging模块",
# "logging模块2", ignore=shutil.ignore_patterns("__init__.py"))
...
# 获取磁盘使用空间
total, used, free = shutil.disk_usage(".")  #  . 代表的是当前盘
...
# shutil.unpack_archive('/Users/jingliyang/PycharmProjects/面试题/常用模块/shutil模块/logging2.zip',
# '/Users/jingliyang/PycharmProjects/面试题/常用模块/shutil模块/tmp')